              ...
              <div className="g-0 lg:flex lg:flex-wrap">
                <div className="px-4 md:px-0 lg:w-6/12">
                  <div className="md:mx-6 md:p-12">
                    ...
                    <form id="loginForm" onSubmit={handleSubmit}>
                      <p className="mb-4 font-medium">Login to your account</p>
                      <div
                ...
                >
                  <div className="px-4 py-6 text-[#252D3B] md:mx-6 md:p-12">
                    ...
                    <p className="text-sm">
                      MindScribe is your partner in self-discovery and emotional
                      well-being. Through guided reflection, mood tracking, and
                      meaningful insights, we empower you to better understand
